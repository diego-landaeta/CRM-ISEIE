...
// Construye un CSV (RFC4180) escapando comillas dobles y comas. La primera fila es
// la cabecera. Devuelve la cadena lista para Blob.
...
function downloadBlob(content: string, filename: string, mime = 'text/csv;charset=utf-8') {
  // BOM para que Excel lo abra como UTF-8 sin romper acentos
...
export default function ExpensesPage() {
  ...
  async function handleExport() {
    try {
      // Trae hasta 10k filas para CSV (límite backend = 100 — usamos paginación).
      ...
      let page = 1;
      while (page <= 200) {
        const res = await expensesApi.list({ ...params, page });
